    ...
    <header className="fixed w-full bg-[#0EA5E9]/80 backdrop-blur-sm z-50 border-b">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold text-white">Thea Anne Mae</span>
        </Link>
        <nav className="hidden md:flex space-x-8">
          ...
          <a href="#testimonials" className="text-white hover:text-secondary transition-colors">Testimonials</a>
          <a href="#certificates" className="text-white hover:text-secondary transition-colors">Certificates</a>
